...
const IBEACON_FRAME_LENGTH = 22;
const IBEACON_UUID_OFFSET = 1;
const IBEACON_MAJOR_OFFSET = 17;
const IBEACON_MINOR_OFFSET = 19;
const IBEACON_TX_POWER_OFFSET = 21;
...
function processIBeacon(data) {
  ...
  return { deviceIds: [ deviceId ] , txPower: txPower };
}
