...
function processMeasurementV6(sensorType, measurement) {
  let rawValue = decodeZigZag(measurement.readUIntBE(0, 3));
...
/**
 * Convert a ZigZag-encoded integer to a signed integer.
 * @param {Number} data The ZigZag-encoded integer.
 * @return {Number} The decoded signed integer.
 */
function decodeZigZag(data) {
