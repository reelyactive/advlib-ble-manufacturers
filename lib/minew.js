...
function processConnectV3Type1e(data) {
  ...
  let isContactDetected = [ !(flags & V3_1E_CONTACT_MASK) ];
  let occupancyDetectionCycle = data.readUInt8(
                                       V3_1E_OCCUPANCY_DETECTION_CYCLE_OFFSET);
  let tamperCycle = data.readUInt8(V3_1E_TAMPER_CYCLE_OFFSET);
  ...
  let sensorData = {
      ...
      occupancyDetectionCycle: occupancyDetectionCycle,
      tamperCycle: tamperCycle,
      uri: MINEW_URI
  };
